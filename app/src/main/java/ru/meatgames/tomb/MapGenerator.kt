...
class MapGenerator(
    ...
    private fun MapController.checkZone(
        mapX: Int,
        mapY: Int,
        width: Int,
        height: Int,
    ...
    fun generateMap(): NewMapConfig {
        val mapController = MapController(mapWidth, mapHeight)
    ...
    private fun MapController.getRandomOuterWall(
    ...
    private fun MapController.clearMap() {
    ...
    private fun MapController.placeRoom(
        x: Int,
        y: Int,
        room: Room,
    ) {
    ...
    private fun MapController.changeTile(
        mapX: Int,
        mapY: Int,
        floorTile: Tile,
        objectTile: Tile,
